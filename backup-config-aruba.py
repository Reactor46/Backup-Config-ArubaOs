...
for host in hosts:
	...
	print('...................ARUBA COMMAND SHOW RUN OUTPUT......................\n')
	output = net_connect.send_command('show run')
	hostname = net_connect.send_command('sh run| incl hostname')

	# Print output to console screen
	print(output)
	print('-------------- Output from ' + hostname + '------------------')
	print()
	print()
  ...
  # Write output to file above
    ...
    destinationvar1 = destination.replace('"', '')
    destinationvar2 = destinationvar1.replace('hostname ', '')

    os.rename(source, destinationvar2)